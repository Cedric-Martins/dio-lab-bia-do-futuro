...
| Arquivo | Formato | Para que serve no Clara Finanças? |
|---------|---------|---------------------|
...
O produto Fundo Imobiliário (FII) substituiu o Fundo Multimercado, pois pessoalmente me sinto mais confiante em usar apenas produtos financeiros que eu conheço. Assim, poderei validar as respostas da CLara Finanças de forma mais assertiva.
...
transacoes = pd.read_csv('data/tansacoes.csv')
...
Para simplicar, podemos simplesmente "injetar" os dados em nosso prompt, garantindo que o Agente tenha o mlhoer contexto possível. Lembrando que, em soluções mais robustas, o ideal é que essas informações sejam carregadas dinamicamente para que possamos ganhar mais flexibilidade.
...
[
  ...
  },
  {
    ...
    "categoria": "fundo",
    "risco": "medio",
    "rentabilidade": "Dividend Yield (DY) costuma a ficar entre 6% a 12% ao ano",
    "aporte_minimo": 100.00,
